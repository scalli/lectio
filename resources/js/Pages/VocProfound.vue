      ...
      <div v-if="show_preferences" class="pt-2 pb-2 pl-2 pr-2 bg-white pt-2 pb-2 pl-2 pr-2 ml-2 mr-2 mt-2 md:w-1/2 lg:w-1/3 md:mx-auto">
           ...
           <div>
            ...
            <div class="mb-2">
              ...
              <button class="bg-lime-300 hover:bg-lime-400 font-bold py-2 px-4 mt-1 rounded" @click="plus10">+10</button>
            </div>
...
<div class="grid grid-cols-12 ml-1 mr-1 mt-4">
        <div class="grid grid-cols-12 bg-lime-300 rounded-full pt-2 pb-2  col-start-1 col-span-12 md:col-start-5 md:col-end-9">
      ...
      <div v-if="!show_solution"  id="currentFront" class="border-lime-300 border-2 rounded bg-white  mt-4 px-4 py-4 w-3/4 md:w-1/3 text-3xl mx-auto font-bold">
      ...
      <div v-if="show_solution"  id="currentBack" class="flex justify-center border-lime-300 border-2 rounded bg-white  mt-4 px-4 py-4 w-3/4 md:w-1/3 text-xl mx-auto font-bold">
        {{current_exercise.ex["back"]}}
      </div>

      <div class="flex justify-center border-lime-300 border-2 rounded bg-white  mt-4 px-4 py-4 w-3/4 md:w-1/3 text-xl mx-auto font-bold">
        <form>
      ...
      <div v-if="newPressed"  id="evaluation" class="flex justify-center mt-4 px-4 py-4 w-3/4 md:w-1/3 text-xl mx-auto font-bold">
        <button class="bg-lime-300 hover:bg-lime-500 text-white font-bold py-2 px-4 rounded mr-1" @click="evaluate">Controleer!</button>
      </div>

      <div v-if="controlPressed"  id="new" class="flex justify-center mt-4 px-4 py-4 w-3/4 md:w-1/3 text-xl mx-auto font-bold">
        <button class="bg-lime-300 hover:bg-lime-500 text-white font-bold py-2 px-4 rounded mr-1" @click="newExercise">Volgende</button>
      </div>
