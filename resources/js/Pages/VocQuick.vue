  ...
  <div class="bg-gray-100 dark:bg-gray-900 h-screen">
    ...
    <div
      class="
        ...
        font-bold
      "
      @click="toggleShowPreferences($event)"
    >
      &#8595; Instellingen &#8595;
    </div>
    <div
      ...
      @click="toggleShowPreferences($event)"
    >
      {{ this.checkedWords.length }} woorden geselecteerd. Klik hier om te
      wijzigen.
    </div>
    <div
      v-if="show_preferences"
      class="
        pt-2
        pb-2
        pl-2
    ...
    >
      <div>
        ...
        <label for="show_phrase" class="pl-2 font-bold"
          >Toon woordgroepen</label
        >
      </div>
      ...
      <div class="mb-2">Selecteer de woorden die je wil oefenen.</div>
      <div class="mb-2">
        <button
        ...
        <button
          class="bg-lime-300 hover:bg-lime-400 font-bold py-2 px-4 rounded mr-1"
          @click="selectFirstHalf"
        >
          1e helft
        </button>
        <button
          class="bg-lime-300 hover:bg-lime-400 font-bold py-2 px-4 rounded"
          @click="selectSecondHalf"
        >
          2e helft
        </button>
        <button
        ...
        <div v-for="(word, index) in voc">
          <div>
            <input
              ...
              class="pr-1"
            />
            <label :for="word.id" class="pl-2 font-bold"
              ><span>{{ word["word"] }}</span></label
            >
          </div>
        </div>
      </div>
    ...
    <div class="grid grid-cols-12">
      ...
      >
        <div
          :class="{
            'col-span-1': isOneTwelfth,
            'col-span-2': isTwoTwelfth,
            'col-span-3': isThreeTwelfth,
            'col-span-4': isFourTwelfth,
            'col-span-5': isFiveTwelfth,
            'col-span-6': isSixTwelfth,
            'col-span-7': isSevenTwelfth,
            'col-span-8': isEightTwelfth,
            'col-span-9': isNineTwelfth,
            'col-span-10': isTenTwelfth,
            'col-span-11': isElevenTwelfth,
            'col-span-12': isTwelveTwelfth,
          }"
          class="
            bg-lime-600
            rounded-full
    ...
    <div class="grid grid-cols-12 pt-2 pb-2 ml-1 mr-1 mt-4">
      ...
      >
        <div>
          <div
            class="
              bg-pink-500
              text-zinc-100
              border-4 border-pink-600 border-t-0
              text-center
              px-4
              py-6
              font-bold
          ...
          <div
            ...
            v-if="current_exercise.ex['box'] == 1"
          >
            *
          </div>
        </div>
        ...
        <div>
          ...
          <div
            class="text-center text-blue-500 text-3xl"
            v-if="current_exercise.ex['box'] == 2"
          >
            *
          </div>
        </div>
        ...
        <div>
          ...
          <div
            class="text-center text-blue-500 text-3xl"
            v-if="current_exercise.ex['box'] == 3"
          >
            *
          </div>
        </div>
