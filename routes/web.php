...
Route::get('/text/new', 'App\Http\Controllers\TextController@new')->name('newtext')->middleware('auth');//->middleware('auth');
Route::post('/text/new', 'App\Http\Controllers\TextController@save')->middleware('auth');//->middleware('auth');
